...
bpro1_process::bpro1_process() { parameters_ = new bpro1_parameters; }
...
bpro1_process::bpro1_process(const bpro1_process& other)
    : input_data_(other.input_data_), output_data_(other.output_data_),
      parameters_(
          new bpro1_parameters(other.parameters_)), // deep copy of parameters
...
void bpro1_process::set_input(const vcl_vector<bpro1_storage_sptr>& i,
                              unsigned frame) {
...
vcl_vector<bpro1_storage_sptr> const&
bpro1_process::get_output(unsigned frame) {
...
bpro1_parameters_sptr bpro1_process::parameters() { return parameters_; }
